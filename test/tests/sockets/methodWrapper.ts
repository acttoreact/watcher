import getMethodWrapper from '../../../utils/getMethodWrapper';
...
test('Method wrapper should build method processing requests', (): void => {
  const methodWrapper = getMethodWrapper();
  expect(methodWrapper).toBe(expected);
})